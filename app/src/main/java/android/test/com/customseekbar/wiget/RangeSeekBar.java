package android.test.com.customseekbar.wiget;
...
import android.test.com.customseekbar.BitmapUtil;
import android.test.com.customseekbar.PixelUtil;
import android.test.com.customseekbar.R;
...
public class RangeSeekBar<T extends Number> extends ImageView {
     ...
     */
    public static final int ACTIVE_COLOR = Color.argb(255, 57 ,70, 79);
//    public static final int ACTIVE_COLOR = Color.argb(255, 255, 153, 0);
    /**
    ...
    private void init(Context context, AttributeSet attrs) {
        float barHeight;
        int thumbNormal = R.drawable.ic_seek_thumb_normal;
        int thumbPressed = R.drawable.ic_seek_thumb_pressed;
        int thumbDisabled = R.drawable.ic_seek_thumb_normal;
       // int thumbNormal = Color.GRAY;
       // int thumbPressed = Color.GREEN;
       // int thumbDisabled = Color.RED;
...
//   mThumbHalfWidth = 0.5f *100;
//        mThumbHalfHeight = 0.5f * 100;
        ...
        mRect = new RectF(padding,
                mTextOffset + mThumbHalfHeight - barHeight / 3,
                getWidth() - padding,
                mTextOffset + mThumbHalfHeight + barHeight / 3);
    ...
    protected synchronized void onDraw(@NonNull Canvas canvas) {
        ...
        if (mShowLabels) {
            ...
            String minLabel = "min price";
            String maxLabel = "max price";
